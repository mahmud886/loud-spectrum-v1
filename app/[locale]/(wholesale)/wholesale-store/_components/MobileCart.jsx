  ...
  return (
    <div>
      <div className="rounded-2xl border border-gray-200 bg-white p-4">
        ...
        {cart.length === 0 ? (
          <div className="py-8 text-center text-[12px] text-gray-500">{t('cart.empty') || 'No items in cart'}</div>
        ) : (
        ...
        <div className="mt-4">
          <button
            className="w-full rounded-full bg-gray-100 px-5 py-2.5 text-[12px] text-gray-900 hover:bg-gray-200"
