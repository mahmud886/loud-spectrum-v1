...
const termsSections = [
  {
    icon: <Info className="text-umbra-100 mr-3 text-2xl" />,
    title: 'OVERVIEW',
    content: (
      <div className="space-y-2">
        <p>
          This website is operated by Sauce Terps. Throughout the site, the terms “we”, “us” and “our” refer to Sauce
          Terps. Sauce Terps, offers this website, including all information, tools, and services available from this
  ...
  {
    icon: <ShoppingCart className="text-umbra-100 mr-3 text-2xl" />,
  ...
  {
    icon: <Settings className="text-umbra-100 mr-3 text-2xl" />,
  ...
  {
    icon: <Clipboard className="text-umbra-100 mr-3 text-2xl" />,
  ...
  {
    icon: <DollarSign className="text-umbra-100 mr-3 text-2xl" />,
  ...
  {
    icon: <User className="text-umbra-100 mr-3 text-2xl" />,
  ...
  {
    icon: <ExternalLink className="text-umbra-100 mr-3 text-2xl" />,
  ...
  {
    icon: <MessageCircle className="text-umbra-100 mr-3 text-2xl" />,
  ...
  {
    icon: <AlertTriangle className="text-umbra-100 mr-3 text-2xl" />,
  ...
  {
    icon: <XCircle className="text-umbra-100 mr-3 text-2xl" />,
  ...
  },
  {
    ...
    content: (
      <div className="space-y-2">
        ...
        <p>
          In no case shall Sauce Terps, our directors, officers, employees, affiliates, agents, contractors, interns,
  ...
  {
    icon: <CheckCircle className="text-umbra-100 mr-3 text-2xl" />,
    title: 'SECTION 14 – INDEMNIFICATION',
    content: (
      <div className="space-y-2">
        <p>
          You agree to indemnify, defend and hold harmless Sauce Terps and our parent, subsidiaries, affiliates,
  ...
  {
    icon: <BookOpen className="text-umbra-100 mr-3 text-2xl" />,
  ...
  {
    icon: <Trash2 className="text-umbra-100 mr-3 text-2xl" />,
  ...
  {
    icon: <List className="text-umbra-100 mr-3 text-2xl" />,
    ...
    content: (
      <div className="space-y-2">
        <p>
          ...
          construed in accordance with the laws of California, United States.
        </p>
      </div>
    ),
  },
  ...
  {
    icon: <ArrowLeft className="text-umbra-100 mr-3 text-2xl" />,
    title: 'SECTION 20 – RETURN POLICY',
    content: (
      <div className="space-y-2">
        <p>
          Due to the nature of the products. We do not accept any returns. Questions about the Terms of Service should
          be sent to us at{' '}
  ...
  return (
    <div className="container mt-[200px]">
      <div className="flex items-center justify-center">
        <h2 className="text-umbra-100 w-[90%] text-center font-sans text-[35px] leading-[120%] font-normal md:w-[65%] md:text-[60px]">
          Terms & Conditions
        </h2>
      </div>
          ...
          <div className="space-y-8">
            {termsSections.map((section, idx) => (
              <div key={section.title}>
                ...
                {idx !== termsSections.length - 1 && <div className="border-umbra-10 my-6 border-b" />}
              </div>
            ))}
          </div>
        </div>
