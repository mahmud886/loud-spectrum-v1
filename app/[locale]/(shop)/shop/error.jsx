...
export default function ShopSectionError({ error, reset }) {
    ...
    <div className="container mx-auto my-[100px]">
      <div className="mx-auto max-w-2xl text-center">
        ...
        <h1 className="mb-4 text-4xl font-bold text-gray-900">
          {t('sectionError.title', { defaultValue: 'Shop Loading Error' })}
        </h1>

        <p className="mb-8 text-lg text-gray-600">
          {t('sectionError.description', {
            defaultValue:
              'We encountered an error while loading the shop section. Please try again or contact support if the problem persists.',
          })}
        </p>
        ...
        <div className="mt-12 rounded-lg bg-gray-50 p-6">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            >
              {t('sectionError.alternatives.blog', { defaultValue: 'Read Blog' })}
            </Link>
            <Link
              href="/about"
              className="inline-flex items-center justify-center rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 transition-colors hover:bg-gray-50"
