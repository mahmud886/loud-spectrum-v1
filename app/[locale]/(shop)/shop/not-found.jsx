...
export default function ShopSectionNotFound() {
    ...
    <div className="container mx-auto my-[100px]">
      <div className="mx-auto max-w-2xl text-center">
        ...
        <h1 className="mb-4 text-4xl font-bold text-gray-900">
          {t('sectionNotFound.title', { defaultValue: 'Shop Section Not Found' })}
        </h1>

        <p className="mb-8 text-lg text-gray-600">
          {t('sectionNotFound.description', {
            defaultValue: "Sorry, the shop section you're looking for doesn't exist or may have been moved.",
          })}
        </p>
        ...
        <div className="mt-12 rounded-lg bg-gray-50 p-6">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            ...
            <Link href="/blog" className="text-primary hover:text-primary/80 inline-flex items-center font-medium">
              {t('sectionNotFound.explore.blog', { defaultValue: 'Blog' })}
            </Link>
            <span className="text-gray-400">•</span>
