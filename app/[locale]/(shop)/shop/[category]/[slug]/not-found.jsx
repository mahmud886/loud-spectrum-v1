    ...
    <div className="container mx-auto my-[100px]">
      <div className="mx-auto max-w-2xl text-center">
        ...
        <h1 className="mb-4 text-4xl font-bold text-gray-900">
          {t('productNotFound.title', { defaultValue: 'Product Not Found' })}
        </h1>

        <p className="mb-8 text-lg text-gray-600">
          {t('productNotFound.description', {
            defaultValue: "Sorry, the product you're looking for doesn't exist or may have been moved.",
          })}
        </p>
        ...
        <div className="flex flex-col justify-center gap-4 sm:flex-row">
          ...
          >
            {t('productNotFound.backToShop', { defaultValue: 'Back to Shop' })}
          </Link>
          ...
          >
            {t('productNotFound.contactUs', { defaultValue: 'Contact Us' })}
          </Link>
        </div>
        ...
        <div className="mt-12 rounded-lg bg-gray-50 p-6">
          <h3 className="mb-3 text-lg font-medium text-gray-900">
            {t('productNotFound.explore.title', { defaultValue: 'Explore Our Products' })}
          </h3>
          <p className="mb-4 text-gray-600">
            {t('productNotFound.explore.description', {
              defaultValue: "While you're here, why not explore our other great products?",
            })}
          </p>
          <div className="flex flex-wrap justify-center gap-3">
            <Link href="/shop" className="text-primary hover:text-primary/80 inline-flex items-center font-medium">
              {t('productNotFound.explore.allProducts', { defaultValue: 'All Products' })}
            </Link>
            <span className="text-gray-400">•</span>
            <Link href="/blog" className="text-primary hover:text-primary/80 inline-flex items-center font-medium">
              {t('productNotFound.explore.blog', { defaultValue: 'Blog' })}
            </Link>
            <span className="text-gray-400">•</span>
            <Link href="/about" className="text-primary hover:text-primary/80 inline-flex items-center font-medium">
              {t('productNotFound.explore.about', { defaultValue: 'About Us' })}
            </Link>
          </div>
        </div>
      </div>
