import OrderFailedEmail from '@/components/emails/OrderFailedEmail';
  ...
  try {
    ...
    const emailHtml = await render(
      OrderFailedEmail({
        ...
        rejectionReason: 'Payment authorization failed. Please verify your payment method and try again.',
      }),
    );
    ...
    console.error('Error generating order failure email preview:', error);
