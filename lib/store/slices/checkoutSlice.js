...
export const selectPaymentPayload = (state) => {
  ...
  return {
    ...
    products: cart.items.map((item) => ({
      ...
      product_type: item.isWholesale ? 'Wholesale' : 'Regular',
    ...
    // Billing address
    billing_address: checkout.billingAddress.sameAsShipping
      ? {
          first_name: checkout.shippingAddress.firstName,
          last_name: checkout.shippingAddress.lastName,
          email: checkout.shippingAddress.email,
    ...
    // Order summary
    subtotal: checkout.orderSummary.subtotal,
    shipping_cost: checkout.orderSummary.shipping,
    discount: checkout.orderSummary.discount,
    tax: checkout.orderSummary.tax,
    total: checkout.orderSummary.total,
    total_volume: checkout.orderSummary.totalVolume,

    // Shipping details
    courier: checkout.selectedCourier,
    shipping_type: checkout.shippingType,
