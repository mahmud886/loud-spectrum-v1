...
const TerpeneGuideHero = () => {
  ...
  return (
    <div className="bg-umbra-100 relative h-[374px] overflow-hidden xl:h-[689px]">
      {/* Background Image */}
      <Image
        ...
        width={1440}
        height={689}
        className="absolute top-0 left-1/2 z-0 h-full w-full -translate-x-1/2 object-cover xl:h-[689px] xl:w-[1920px]"
        priority
      />

      <div className="absolute inset-0 z-10 container h-[450px] w-full overflow-hidden xl:h-[550px]">
        {/* Content */}
        <div className="relative z-10 flex h-full w-full flex-col items-center justify-center gap-[40px] xl:w-2/5">
          <div>
