...
const ContactHero = () => {
  ...
  return (
    <div>
      <div className="bg-umbra-100 h-[1008px] overflow-hidden xl:h-[786px]">
        <div className="z-10 container mt-[200px] w-full overflow-hidden">
          <div className="flex min-h-[580px] flex-col justify-between">
            ...
            <div className="w-full">
              <div className="mt-20 mb-4 flex w-full flex-col items-center gap-4 xl:mt-0 xl:mb-12 xl:flex-row xl:items-end">
                <div className="flex w-full flex-col space-y-2 xl:w-auto">
                ...
                <div className="text-white-40 mt-12 mr-auto font-mono text-[16px] leading-[140%] font-normal xl:mt-0 xl:ml-auto">
                  {t('contactHero.hours')}
                </div>
              </div>
