...
const ShopHeroShimmer = () => {
  return (
    <div className="relative h-[510px] overflow-hidden bg-black xl:h-[797px]">
      <Skeleton className="absolute top-0 left-1/2 z-0 h-full w-full -translate-x-1/2 object-cover xl:w-[1920px]" />
      ...
      <div className="absolute bottom-0 left-1/2 z-20 w-full -translate-x-1/2 xl:w-[1440px]">
        <Skeleton className="h-[50px] w-full object-cover xl:h-[195px] xl:w-[1440px]" />
      </div>
    </div>
  );
};
