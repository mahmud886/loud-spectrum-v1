...
const OurVision = () => {
  ...
  return (
    <div className="container">
      <div className="relative h-[720px] w-full overflow-hidden md:h-[592px]">
        ...
        <div className="relative z-20 flex h-full items-end px-5 pt-10 md:items-center md:px-[100px]">
          <div className="space-y-6 pb-10 text-white md:max-w-[400px] md:pb-0">
            <h6 className="heading-6">{t('subtitle')}</h6>
            <h2 className="font-sans text-[32px] leading-[120%] font-normal tracking-normal md:text-[44px]">
              {t('title')}
            </h2>
