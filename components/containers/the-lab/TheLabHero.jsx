  ...
  return (
    <div className="container mt-[200px]">
      <div className="mb-6 flex items-center justify-center text-center">
        <h2 className="text-umbra-100 font-sans text-[35px] leading-[120%] font-normal md:w-1/2 md:text-[60px]">
          {t('heading')}
        </h2>
      </div>
      <div className="space-y-20 pt-16">
        <div className="relative h-[427px] overflow-hidden bg-white md:h-[631px]">
          {/* Background Image */}
          <Image
            ...
            width={1280}
            height={631}
            className="absolute top-0 left-1/2 z-0 h-[427px] w-full -translate-x-1/2 object-cover md:h-full md:w-[1280px]"
            priority
          />
        </div>
        <div className="flex flex-col items-center justify-center pt-12 md:flex-row md:pt-[100px]">
          <div className="flex w-full flex-col items-start justify-center gap-12 md:min-w-[80%] md:flex-row md:gap-20">
