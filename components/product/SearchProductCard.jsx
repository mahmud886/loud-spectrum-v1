  ...
  return (
    <motion.div initial="rest" whileHover="hover" animate="rest" className="cursor-pointer">
      <Link
        ...
        className="relative flex h-[384px] w-full flex-col justify-around overflow-hidden border bg-[#F5F5F5] p-2.5 xl:h-[384px] xl:w-full"
      ...
      >
        ...
        <div className="flex h-full w-full items-center justify-center overflow-hidden">
          ...
          >
            <Image
              className="h-[280px] w-auto object-contain xl:h-[300px] xl:w-[280px]"
              src={
                product?.image
        ...
        <div className="absolute top-2 left-3 z-10 w-full">
          <button
            className="border-umbra-100 rounded-[3px] border bg-white/90 px-2 text-[11px] font-normal xl:text-[12px]"
            type="button"
            tabIndex={-1}
          >
        ...
        {/* <div className="absolute bottom-3 left-3 z-10 flex w-full flex-col items-start bg-[#F5F5F5] text-left">
          <h2 className={clsx('text-[16px] font-normal text-black xl:text-[18px]')}>{product.name}</h2>
          <p className={clsx('text-umbra-40 text-[11px] xl:text-[12px]')}>
        ...
        <div className="absolute bottom-3 left-3 z-10 flex w-full flex-col items-start bg-[#F5F5F5] text-left">
          ...
          <DiscountPriceDisplay
            ...
            originalPriceClass={clsx(
              'text-umbra-40 text-[11px] xl:text-[12px] line-through opacity-60',
              isShopPage ? 'text-umbra-40' : 'text-white-40',
            )}
            discountedPriceClass={clsx(
              'text-umbra-40 text-[11px] xl:text-[12px] font-normal',
              getCategoryTextClasses(product?.category?.name),
            )}
            regularPriceClass={clsx(
              'text-umbra-40 text-[11px] xl:text-[12px]',
              isShopPage ? 'text-umbra-40' : 'text-white-40',
            )}
