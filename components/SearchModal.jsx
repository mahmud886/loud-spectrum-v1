...
const SearchModal = ({ open, onOpenChange }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* Modal Content */}
      <div className="bg-umbra-100 relative max-h-[90vh] w-[96vw] max-w-[96vw] overflow-hidden rounded-lg shadow-xl md:w-[60vw]">
        ...
        <div className="p-4">
          {!search ? null : loading ? (
            <div className="grid max-h-[60vh] grid-cols-2 items-center gap-4 overflow-y-auto p-4 align-middle md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3">
