...
import { CheckCircle, CreditCard, Hash, MapPin, Package, Truck, User } from 'lucide-react';
import { useTranslations } from 'next-intl';
import Image from 'next/image';
import { useEffect, useState } from 'react';
import Confetti from 'react-confetti';

const GuestOrderConfirmation = ({ orderData, guestEmail }) => {
    ...
    return (
      <div className="flex min-h-[400px] items-center justify-center">
        <div className="text-center">
          ...
          <p className="mb-4 text-gray-600">We couldn't find your order details.</p>
        ...
        <CardContent className="space-y-3">
          <div className="text-center">
            <p className="text-sm text-blue-700">
              <strong>Order confirmation sent to:</strong> {guestEmail}
            </p>
            <p className="mt-2 text-xs text-blue-600">Please save this page or take a screenshot for your records.</p>
          </div>
          <div className="rounded-lg border border-blue-300 bg-blue-100 p-3">
            <h4 className="mb-2 font-semibold text-blue-800">Important Information:</h4>
            <ul className="space-y-1 text-xs text-blue-700">
              <li>• Your order confirmation has been sent to your email</li>
              <li>
                • You can track your order using the order number: <strong>{code}</strong>
              </li>
              <li>• For order inquiries, contact support with your order number</li>
              <li>• Consider creating an account for easier order tracking in the future</li>
            </ul>
          </div>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardContent className="pt-6">
          <div className="space-y-2 text-center">
            ...
            <p className="text-sm text-gray-600">We'll send you shipping updates via email as your order progresses.</p>
            <p className="text-sm text-gray-600">
              For any questions about your order, please contact our support team with your order number:{' '}
              <strong>{code}</strong>
            </p>
          </div>
        </CardContent>
