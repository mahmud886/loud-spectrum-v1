  ...
  return (
    <div className="animate-pulse">
      ...
      <nav className="bg-white-100/60 fixed top-0 left-0 z-50 w-full backdrop-blur-xl">
        <div className="container mx-auto flex items-center justify-between px-5 py-12 transition-all duration-300 md:px-[40px] lg:px-[40px] xl:px-[80px] 2xl:px-[320px]">
          {/* Logo shimmer */}
          <div className="h-[25px] w-[153px] rounded bg-gray-200 md:h-[36px] md:w-[221px] lg:h-[36px] lg:w-[221px]"></div>
