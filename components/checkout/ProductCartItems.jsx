...
const ProductCartItems = ({ item }) => {
  ...
  return (
    <div
      className={`bg-umbra-5 flex items-center gap-2 rounded-md border-1 py-2.5 pr-5 pl-2.5 md:gap-4 ${
        ...
        <div className="flex w-full items-end justify-between gap-5">
          <div className="mt-2 flex items-center gap-2">
            ...
            >
              ...
              {/* Quantity */}
              <div className="text-umbra-100 flex items-center justify-center px-2 py-1 text-[12px] leading-[120%] font-normal sm:text-[14px] md:text-[16px] md:font-medium">
                {item.quantity}
              </div>
          ...
          <div>
            <p className="text-umbra-100 font-sans text-[12px] leading-[120%] font-normal sm:text-[16px]">
