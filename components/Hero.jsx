    ...
    <>
        ...
        <div className="relative container h-[900px] overflow-hidden">
          <>
            ...
            {/* <Image
              ...
              width={450}
              height={900}
              className="absolute top-0 left-1/2 z-0 h-[900px] w-[450px] -translate-x-1/2 xl:hidden"
              priority
            /> */}
            {/* Desktop Image */}
            {/* <Image
              ...
              width={1440}
              height={900}
              className="absolute top-0 left-1/2 z-0 hidden h-[900px] w-[1440px] -translate-x-1/2 object-cover xl:block"
              priority
            /> */}
          ...
          <div className="relative z-30 flex h-[900px] flex-col justify-end gap-6 lg:w-3/6 xl:w-3/6 xl:items-center xl:justify-center xl:gap-[40px]">
            <div className="space-y-6 xl:space-y-0">
              <h1 className="font-sans text-[35px] leading-[120%] font-normal tracking-normal text-white lg:pb-5 lg:text-[60px] xl:pb-5 xl:text-[60px]">
                {t('The_Premier_Terpene_Experience')}
              </h1>
              <p className="pb-6 font-mono text-[20px] leading-[140%] font-normal text-white xl:pb-0">
                {t(
            ...
            <div className="mb-12 flex w-full flex-col gap-[15px] lg:mb-0 lg:self-start xl:mb-0 xl:flex-row xl:self-start">
              <Link
                href={`/shop`}
                className="special-button inline-flex cursor-grab items-center justify-center rounded-full px-6 py-4 lg:py-2 xl:py-2"
              >
                {t('Explore_the_shop')}
              </Link>
              <Link
                href={`/try-sample-pack`}
                className="outline-button-black inline-flex cursor-grab items-center justify-center rounded-full px-6 py-4 lg:py-2 xl:py-2"
              >
                {t('Try_a_Sample_Pack')}
              </Link>
            </div>
      ...
      <div className="mx-auto w-[375px] lg:flex lg:w-[1440px] xl:flex xl:w-[1440px]">
        <Image
          ...
          width={1440}
          height={195}
          className="h-[50px] w-[375px] bg-black object-cover lg:h-[195px] lg:w-[1440px] xl:h-[195px] xl:w-[1440px]"
        />
      </div>
    </>
